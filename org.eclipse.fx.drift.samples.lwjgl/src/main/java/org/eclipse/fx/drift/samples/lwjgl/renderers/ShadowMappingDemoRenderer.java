...
public class ShadowMappingDemoRenderer implements ISampleRenderer {
	...
	public String toString() {
		return "lwjgl - ShadowMappingDemo";
	}
    ...
    public void render(Vec2i size, RenderTarget target) {
		...
		if (width > 0 && height > 0
				&& (ShadowMappingDemoRenderer.this.width != width || ShadowMappingDemoRenderer.this.height != height)) {
			ShadowMappingDemoRenderer.this.width = width;
			ShadowMappingDemoRenderer.this.height = height;
		}
